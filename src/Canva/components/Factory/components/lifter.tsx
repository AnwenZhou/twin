...
import { createMetalMaterial } from '../../../utils/metalMaterials';
...
function Lifter(props: ILifter) {
  ...
  const lifterMaterial = useMemo(() => createMetalMaterial('silver'), []);
  const lifterPlaneMaterial = useMemo(() => createMetalMaterial('orangeSteel'), []);
  return (
    <group {...groupProps}>
      <mesh
